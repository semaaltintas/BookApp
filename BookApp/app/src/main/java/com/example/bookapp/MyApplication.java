...
public class MyApplication extends Application {
    ...
    public static void deleteBook(Context context, String bookId, String bookUrl, String bookTitle) {
        ...
        progressDialog.setTitle("Siliniyor"+ bookTitle+ "...");
        progressDialog.setCanceledOnTouchOutside(false);



        Log.d(TAG, "deleteBook: Storageden siliniyor");
        StorageReference storageReference = FirebaseStorage.getInstance().getReferenceFromUrl(bookUrl);
        storageReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Log.d(TAG, "onSuccess: Storageden silindi.");

                        Log.d(TAG, "onSuccess: Dbden siliniyor");
                        ...
                        reference.child(bookId)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Log.d(TAG, "onFailure: Silme işlemi başarısız."+e.getMessage());
                                        progressDialog.dismiss();
    ...
    public static void loadPdfFormUrlSinglePage(String pdfUrl, String pdfTitle, PDFView pdfView, ProgressBar progressBar, TextView pagesTv) {
        ...
        ref.getBytes(MAX_BYTES_PDF)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressBar.setVisibility(View.INVISIBLE);
                        Log.d(TAG, "onFailure: dosya alımı başarısız"+e.getMessage());
                    }
                });
    }
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl){
        ...
        Log.d(TAG_DOWNLOAD, "downloadBook: "+nameWithExtension);

        progressDialog = new ProgressDialog(context);
        progressDialog.setTitle("Lütfen Bekleyin!");
        progressDialog.setTitle("İndiriliyor "+ nameWithExtension+"...");
        progressDialog.setCanceledOnTouchOutside(false);
        progressDialog.show();
        ...
        storageReference.getBytes(MAX_BYTES_PDF)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    @Override
                    public void onSuccess(byte[] bytes) {
                        Log.d(TAG_DOWNLOAD, "onSuccess: Kitap indirildi.");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG_DOWNLOAD, "onFailure: İndirme Başarısız"+e.getMessage());
                        progressDialog.dismiss();
                        Toast.makeText(context, "İndirme Başarısız"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        Log.d(TAG_DOWNLOAD, "onSuccess: Kitap kaydediliyor...");
        ...
        try {
            ...
            progressDialog.setTitle("Kitap Kaydedildi."+ nameWithExtension+"...");
            progressDialog.setCanceledOnTouchOutside(false);

            Toast.makeText(context, "Kitap Kaydedildi.", Toast.LENGTH_SHORT).show();
            Log.d(TAG_DOWNLOAD, "saveDownloadedBook: İndirme Başarılı.");
            progressDialog.dismiss();
            incrementBookDownloadCount(bookId);
        }
        catch (Exception e){
            Log.d(TAG_DOWNLOAD, "saveDownloadedBook: Kayıt Başarısız."+e.getMessage());
    ...
    private static void incrementBookDownloadCount(String bookId) {
        Log.d(TAG_DOWNLOAD, "incrementBookDownloadCount: İndirme sayısını arttırma");
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Log.d(TAG_DOWNLOAD, "onDataChange: Yeni indirilme sayısı"+newDownloadsCount);
                        ...
                        reference.child(bookId).updateChildren(hashMap)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Log.d(TAG_DOWNLOAD, "onFailure: Güncelleme Başarısız."+e.getMessage());
                                    }
                                });
                    }
        ...
        if(firebaseAuth.getCurrentUser() == null){
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context, "Ekleme başarısız."+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    public static void removeFormFavorite(Context context, String bookId){
        FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
        if(firebaseAuth.getCurrentUser() == null){
            Toast.makeText(context, "Giriş Yapmadınız!", Toast.LENGTH_SHORT).show();
        }
